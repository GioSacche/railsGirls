...
class ServicosControllerTest < ActionController::TestCase
  ...
  test "should create servico" do
    assert_difference('Servico.count') do
      post :create, servico: { Descricao: @servico.Descricao, Nome: @servico.Nome, Status: @servico.Status, Titulo: @servico.Titulo }
    end
  ...
  test "should update servico" do
    patch :update, id: @servico, servico: { Descricao: @servico.Descricao, Nome: @servico.Nome, Status: @servico.Status, Titulo: @servico.Titulo }
    assert_redirected_to servico_path(assigns(:servico))
  end
